...
public class UnboundedMap extends AbstractWorldMap {
    ...
    public UnboundedMap(List<HayStack> stacks){
       super();
        ...
        while(it.hasNext()){
           HayStack tmp = it.next();
            boundary.addObject(tmp,tmp.getPosition());
        }
    }
    ...
    public void place(Animal animal) {
        ...
        boundary.addObject(animal,animal.getPosition());
    }
   ...
   public String toString(){
       return super.stringyfy(boundary.low(),boundary.high());
   }
